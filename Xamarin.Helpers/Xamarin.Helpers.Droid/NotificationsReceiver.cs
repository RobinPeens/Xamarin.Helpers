...
namespace Xamarin.Helpers.Droid
{
    ...
    public class NotificationsReceiver : GcmBroadcastReceiverBase<GcmService>
    {
        /// <summary>
        /// The senderids.
        /// </summary>
    ...
    public class GcmService : GcmServiceBase
    {
        ...
        {
            Log.Info(NotificationsReceiver.Tag, "GcmService() OnError");
        }
        ...
        protected override async void OnRegistered(Context context, string registrationId)
        {
            ...
            try
            {
                var settingsService = IoC.IoCGet<ISettingsService>();

                if (settingsService.Tags.Count == 0)
                {
                    settingsService.Tags.Add("RobinTest");
                }
        ...
        {
            Log.Info(NotificationsReceiver.Tag, "GcmService() OnUnRegistered");
        }
